#ifndef COMKF_POSITIONMEASUREMENTMODEL_HPP_
#define COMKF_POSITIONMEASUREMENTMODEL_HPP_
...
public:
    ...
    //! PositionMeasurement type shortcut definition
    ...
    {        
        ...
        //this->H.setZero();
        this->H.template block<2, 2>(M::PX, S::PX).setIdentity();
        this->H.template block<2, 2>(M::PX, S::BX).setIdentity();
    }
