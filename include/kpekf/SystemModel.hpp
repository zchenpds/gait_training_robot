#ifndef KPEKF_SYSTEMMODEL_HPP_
#define KPEKF_SYSTEMMODEL_HPP_
...
/**
 * @brief System state vector-type for a 6DOF kpekf
 *
...
/**
 * @brief System model for a 6DOF kpekf
 *
 * @param T Numeric scalar type
...
{
    friend class kpekf::ExtendedKalmanFilter<T>;
public:
    //! State type shortcut definition
	typedef kpekf::State<T> S;
    
    //! Control type shortcut definition
    typedef kpekf::Control<T> C;
